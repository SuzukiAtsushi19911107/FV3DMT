          ...
          ColVec_t& adam_vec_v)
{
    ...
    switch (gd_settings.method)
    {
        ...
        case 8: // Adastand by NTT https://www.nttpc.co.jp/gpu/article/benchmark07.html
        {
            adam_vec_m = gd_settings.par_adam_beta_1 * adam_vec_m + (fp_t(1.0) - gd_settings.par_adam_beta_1) * (grad_p - adam_vec_m);

            if (gd_settings.ada_max) {
                adam_vec_v = BMO_MATOPS_MAX(gd_settings.par_adam_beta_2 * adam_vec_v, BMO_MATOPS_ABS(grad_p - adam_vec_v));
                ...
                adam_vec_v = gd_settings.par_adam_beta_2 * adam_vec_v + (fp_t(1.0) - gd_settings.par_adam_beta_2) * BMO_MATOPS_POW(grad_p - adam_vec_v, 2);
